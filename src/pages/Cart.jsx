  ...
  return (
    <section>
      <Container>
        ...
        <Title className='mt-10 pb-[120px]' t_text='Cart' />
              ...
              <tr>
                <td class=' border-[#F0F0F0] w-[1300px] h-[89px] pl-5 text-secondary text-base font-bold font-dm'>
                  <Flex className='items-center'>
                    ...
                    {/* <select name="" id="text" className='border pl-5 border-[#F0F0F0] w-[220px] h-[50px]' >SIZE</select> */}
                    {/* <input className='border pl-5 border-[#F0F0F0] w-[220px] h-[50px]' type="text" placeholder='SIZE' /> */}
